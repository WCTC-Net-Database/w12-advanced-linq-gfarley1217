...
namespace ConsoleRpgEntities.Migrations
{
    ...
    [Migration("20250503045215_SeedItems2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Inventory.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Inventory.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipments.Equipment", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Inventory.Item", "Armor")
                        .WithMany()
                        .HasForeignKey("ArmorId");

                    b.HasOne("ConsoleRpgEntities.Models.Inventory.Item", "Weapon")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Inventory.Inventory", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Characters.Player", "Player")
                        .WithOne("Inventory")
                        .HasForeignKey("ConsoleRpgEntities.Models.Inventory.Inventory", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Inventory.Item", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Inventory.Inventory", null)
                        .WithMany("Items")
